    ...
    <div class="container">
        <div class="pull-left">
            <div class="logo pull-left hidden-sm hidden-xs">
                <a href="<c:url value='/mod'/>"><img src="<c:url value='/images/FlyingBeautiesLogo_88x70.png'/>"  /></a>
            </div>
            ...
            <div class="menu-items pull-right">
                <ul>                
                    <li class="style-nav menu-home"><a href="<c:url value='/mod'/>"><i class="glyphicon glyphicon-home"></i>&nbsp;FLYINGBEATIES MODERATOR</a></li>
                </ul>
            </div>                              
        </div>
