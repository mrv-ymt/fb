...
<body id="list-group-page">
						...
						<li class="border-green">
							<div class="group-content card row">
								...
								<div class="col-md-7 col-xs-12  main-info">
									<div class="statistic">									
										<a href="/web/admin/group/${groupInfo.groupId}"><h3>${groupInfo.groupName}</h3></a>
								...
								<div class="modify-cptt-area">
									<a href="/web/admin/group/${groupInfo.groupId}" class="pull-left" ><img  src='<c:url value='/images/iconpen.png' />'></a>
	...
	<div class="add-btn">
		<a href="/web/admin/addgroup"><img src="<c:url value='/images/add_btn01_off.png' />" /></a>
	</div>
</body>
</html>