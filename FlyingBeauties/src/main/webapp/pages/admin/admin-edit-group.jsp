	...
	<div class="container content">
		...
		<div class="col-md-10 col-xs-12">
			<div class="row border-green">
				...
				<form id="editGroupForm" method="POST" action="<c:url value='/admin/group/edit'/>">
					<input type="hidden" name="groupId" id="groupId" class="form-control" value="${groupInfo.groupId}"/>
					<div class="col-lg-3 col-md-3 col-xs-12">
						<div  class="avatar-area">
							<c:choose>
								<c:when test="${empty groupInfo.groupLogoUrl}">
									<img src="<c:url value='/images/nophoto.jpg'/>"  id="avatar" class="img-thumbnail"/>
								</c:when>
								<c:otherwise>
									<img src="<c:url value='/avatars/${groupInfo.groupLogoUrl}'/>"  alt="No image" id="avatar" class="img-thumbnail"/>
								</c:otherwise>
						...
						<div class="table-responsive border-gray competition-info-area">
							<table class="table">
								<tr>
									...
									<td class="col-2" >
										<input type="text" name="groupName" id="groupName" class="form-control" value="${groupInfo.groupName}"/>
									</td>
								</tr>
								<tr>
									<td class="col-1"><spring:message code='label.group.description' /></td>
									<td class="col-2" >
										<input type="text" name="groupDescription" id="groupDescription" class="form-control" value="${groupInfo.description}" />
									</td>
								</tr>
							</table>
						</div>
