...
<body id="list-competition-page">
						...
						<li class="border-green">
							<div class="competition-content card row">
								...
								<div class="col-md-7 col-xs-12  main-info">
									<div class="statistic">
										<a href="<c:url value='/admin/editcompetition/${competitionInfo.competitionId}'/>"><h3>${competitionInfo.competitionName}</h3></a>
								...
								<div class="modify-cptt-area">
									<a href="<c:url value='/admin/editcompetition/${competitionInfo.competitionId}'/>" class="pull-left" ><img  src='<c:url value='/images/iconpen.png' />'></a>
	...
	<div class="add-btn">
		<a href="<c:url value='/admin/addcompetition'/>"><img src="<c:url value='/images/add_btn01_off.png' />" /></a>
	</div>
</body>
</html>
