                	...
                	<li class="border-green">
	                    <div class="video-wraper form-group">	                        
	                        ...
	                        <div class="main-image">
	                            <div onclick="openModal(${imageInfoDTO.imageId});"><img class="image-orgi" src="<c:url value='/uploadimages/${imageInfoDTO.imageUrl}_t.jpg'/>" /></div>
                            ...
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body row">
                                        <div class="col-md-8 col-xs-12 full-size-image form-group">
