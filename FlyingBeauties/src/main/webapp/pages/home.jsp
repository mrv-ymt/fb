...
<title>${groupInfo.groupName} Group</title>
        ...
        <div class="col-md-10 col-sm-12 col-xs-12 pull-right">
        	<div class="group-info border-green form-group row">
        			<div class="col-xs-5 col-sm-4 col-md-3">
        				<img class="group-logo" src="<c:url value='/avatars/${groupInfo.groupLogoUrl}'/>" />
        			</div>
        			<div class="col-xs-7 col-sm-5 col-md-5 row">
        				<p class="group-name">${groupInfo.groupName}</p>
        				<p><spring:message code='label.totalmember' />: ${groupInfo.participants}</p>
        				<p><spring:message code='label.totalimage' />: ${groupInfo.imageNum}</p>
        				<p><spring:message code='label.totalpoint' />: ${groupInfo.totalPoint}</p>
        				<p>${groupInfo.description}</p>
        			</div>  
       			<div class="top-user-area col-xs-12 col-sm-3 col-md-3">
       				<p class="title"><spring:message code='label.topuser' /></p>
       				<ul>
       					<c:forEach items="${groupInfo.listUser}" var="userInfo">
       						<li class="col-sm-12 col-xs-4">
	       						<div class="profile-area">
		                        	<div class="pull-left">
	 	                            	<img  src="<c:url value='/avatars/${userInfo.avatarUrl}'/>"/> 
		                            </div>
		                            <div class="overflow">
        	...
        	<div class="order-by-choose row">					
				...
				<div class="col-md-3 col-sm-4 col-xs-8">
					...
					<select class="form-control" id="orderBy-homePage">
	        ...
	        <div class="pager row">
				...
				<ul class="pagination pagination-lg">		
					<li class="available-${imageInfoR2S.pager.firstPage}">
						<a href="<c:url value='/home/${imageInfoR2S.pager.firstPage}/${orderBy}'/>"><i class="glyphicon glyphicon-fast-backward"></i></a>
					</li>
					<li class="available-${imageInfoR2S.pager.previousPage}">
						<a href="<c:url value='/home/${imageInfoR2S.pager.previousPage}/${orderBy}'/>"><i class="glyphicon glyphicon-step-backward"></i></a>
					</li>		    
				    <c:forEach items="${imageInfoR2S.pager.pageNumberList}" var="pageNumber">		    
						<c:choose>
						    <c:when test="${pageNumber.equals(imageInfoR2S.pager.currentPage)}">
						    	<li class="active"><a href="<c:url value='/home/${pageNumber}/${orderBy}'/> ">${pageNumber}</a></li>
						    </c:when>
						    <c:otherwise>
						    	<li><a href="<c:url value='/home/${pageNumber}/${orderBy}'/> ">${pageNumber}</a></li>
						    </c:otherwise>
						</c:choose>  
				    </c:forEach>
				    <li class="available-${imageInfoR2S.pager.nextPage}">
						<a href="<c:url value='/home/${imageInfoR2S.pager.nextPage}/${orderBy}'/>"><i class="glyphicon glyphicon-step-forward"></i></a>
					</li>
					<li class="available-${imageInfoR2S.pager.lastPage}">
						<a href="<c:url value='/home/${imageInfoR2S.pager.lastPage}/${orderBy}'/>"><i class="glyphicon glyphicon-fast-forward"></i></a>
					</li>
				</ul>
			</div>   
        </div>             
